...
url_base = entrada["url"]
clases_recibidas = entrada["clases"]
directorio = entrada.get("directorio", "").strip()

#Validar y preparar la ruta de guardado
if directorio and os.path.isdir(directorio):
    csv_path = os.path.join(directorio, 'resultados.csv')
else:
    csv_path = "./resultados.csv"
    if directorio:
        print(f"Advertencia: El directorio '{directorio}' no existe. Guardando en el directorio actual.")
